...
// ── Swing detection ─────────────────────────────────────────────────────
// detectSwings + detectLiquiditySweeps live in sweeps.js (P8.4a: the signal
// engine's edge function bundles just that file); re-exported here so every
// existing consumer keeps importing them from smc.js.
import { detectSwings, detectLiquiditySweeps } from "./sweeps.js";
export { detectSwings, detectLiquiditySweeps };
...
// ── S4: Liquidity Sweep detection — see sweeps.js (re-exported above) ──
